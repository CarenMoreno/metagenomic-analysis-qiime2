...
<table align="center" style="border: none; border-collapse: collapse;">
  <tr style="border: none;">
    ...
    <td align="center" style="border: none; padding: 10px;">
      <img src="figures/alpha_faith_pd_transect-name.png" width="320" alt="Variable: transect-name"><br>
      <sub><b>Transect-name</b></sub>
    </td>
    <td align="center" style="border: none; padding: 10px;">
      <img src="figures/alpha_faith_pd_extract_group_no.png" width="320" alt="Variable: extract_group_no"><br>
...
<table align="center" style="border: none; border-collapse: collapse;">
  <tr style="border: none;">
    <td align="center" style="border: none; padding: 10px;">
      <img src="figures/taxa_barplot_l2.png" width="435" alt="Phylum"><br>
      <sub><b>Level 2: Phylum</b></sub>
    </td>
    <td align="center" style="border: none; padding: 10px;">
      <img src="figures/taxa_barplot_l2_legend.png" width="155" alt="Genus"><br>
      <sub><b>Legend</b></sub>
    </td>    
    <td align="center" style="border: none; padding: 10px;">
      <img src="figures/taxa_barplot_l6.png" width="435" alt="Phylum"><br>
      <sub><b>Level 6: Genus</b></sub>
    </td>
    <td align="center" style="border: none; padding: 10px;">
      <img src="figures/taxa_barplot_l6_legend 1.png" width="355" height="350" alt="Genus"><br>
      <sub><b>Legend</b></sub>
    </td>
  </tr>
</table>
